...
<head>
    ...
    <meta
        content="Hi, my name is Hussein and I am a full-stack developer. I have experience in both front-end and back-end development, and I love using my skills to create innovative and user-friendly applications. My passion for coding drives me to constantly learn and improve, and I am always excited to take on new challenges. Whether you need a website, mobile app, or any other type of software, I am confident that I can deliver a high-quality product that meets your needs. Let's work together to bring your ideas to life!"
        name="description">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto">
                        ...
                        <div class="nav-item dropdown">
                            <a href="team.php" class="nav-link">Our Users</a>
                        </div>
        ...
        <div class="container pt-5">
            <div class="row g-5 pt-5">
                <div class="col-lg-6 align-self-center text-center text-lg-start mb-lg-5">
                    ...
                    <h1 class="display-4 text-white mb-4 animated slideInRight">Artificial Intelligence for Your
                        Business</h1>
                    <p class="text-white mb-4 animated slideInRight">Tempor rebum no at dolore lorem clita rebum rebum
                        ipsum
                        rebum stet dolor sed justo kasd. Ut dolor sed magna dolor sea diam. Sit diam sit</p>
                    <a href="team.php"
                        class="btn border border-info py-sm-3 px-sm-5 rounded-pill me-3 animated slideInRight button_style">Our Users</a>
                    <a href="#" class="btn border border-info py-sm-3 px-sm-5 rounded-pill animated slideInRight button_style">Contact
                        Us</a>
                </div>
        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.3s">
                    ...
                    <p><i class="fa fa-map-marker-alt me-3"></i>Iraq Baghdad</p>
            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <a class="border-bottom" href="index.html">AI Teach</a>, All Right Reserved.
                        Designed By <a class="border-bottom"
                            href="https://hussein430.github.io/My_PersonalSide/">Hussein Alaa</a>
                    </div>
